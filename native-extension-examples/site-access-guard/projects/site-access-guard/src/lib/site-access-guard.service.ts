...
import { AttributeSetResourceType, AttributeSetService, AttributeSetValue, CustomerService } from "@upscale/service-client-angular";
import { AuthenticationService } from "@upscale/web-storefront-sdk";

@Injectable({
  providedIn: 'root'
})
export class SiteAccessGuardService {
